...
public class Configuracion {
  ...
  // public static final String[] CHAT_IDS = {"-1003064907759"}; //<-- este es el chat grupal
	...
	public static ArrayList<String> filtroBookies2UP = new ArrayList<String>(Arrays.asList("2", "48", "7", "39", "69", "45","20", "57", "104"));
	public static ArrayList<String> filtroBookies2UP2WAY = new ArrayList<String>(			Arrays.asList("2", "75", "48", "7", "39", "69", "47", "45","20", "57" , "104"));
